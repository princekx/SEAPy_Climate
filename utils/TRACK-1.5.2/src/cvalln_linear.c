...
double cvalln_linear(struct dpt *dt, int dtn, double sm, double *plt, float *wght, int im, int ht, int ty, int ms)
   ...
   for(i=0; i < dtn; i++) {
       ...
       if(ht < 3) {
          ...
          for(j=0; j < dtn; j++){
              ...
              fd += (ftd = wt * linear_density(dt1, dt2, tsm));
          ...
          for(j=0; j < dtn; j++){
              ...
              fd += (ftd = wt * cnn * linear_density(dt1, dt2, tsm));
