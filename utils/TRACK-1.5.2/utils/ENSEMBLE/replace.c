...
int main(int argc, char **argv)
{
    ...
    if(toverlap(tr1, tr2, &is1, &is2)){
	  ...
	  exit(1);
	   ...
	   fp1->add_fld[4] = fp2->xf;
	   fp1->add_fld[5] = fp2->yf;
	   if(fp2->zf > ADD_CHECK) fp1->add_fld[6] = ADD_UNDEF;
	   else if(fp2->zf < 500.0) fp1->add_fld[6] = ADD_UNDEF;
	   else fp1->add_fld[6] = fp2->zf;
